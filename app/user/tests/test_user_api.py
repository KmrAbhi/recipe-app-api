...
class PublicUserTests(TestCase):
    ...
    def test_create_valid_user_success(self):
        ...
        print(res.data)
        self.assertTrue(user.check_password(payload['password'])),# fix this soon.
    ...
    def test_create_token_for_user(self):
        ...
        payload = {'email': 'test@gmail.com', 'password': 'testPassword', 'name': 'test name'}
        create_user(**payload)
...
class PrivateUserApiTests1(TestCase):
